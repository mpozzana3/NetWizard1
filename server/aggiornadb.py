...
try:
    ...
    tables = [
        ...
        ("file_scansioni", "SELECT * FROM file_scansioni", 
         "INSERT INTO file_scansioni (id_scansione, nmapxml, enum4json, masscanxml, nmaphtml, snmp, p_iva) VALUES (%s, %s, %s, %s, %s, %s, %s)"),
        ...
        ("snmp_scan", "SELECT * FROM snmp_scan",
         "INSERT INTO snmp_scan (id_scansione, hostname, interface_name, port, pid, process_cmd,  p_iva) VALUES (%s, %s, %s, %s, %s, %s, %s)"),
